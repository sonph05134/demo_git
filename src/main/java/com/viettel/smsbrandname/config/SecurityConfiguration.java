...
import com.viettel.smsbrandname.security.*;
...
import com.viettel.smsbrandname.security.oauth2.AudienceValidator;
...
import com.viettel.smsbrandname.security.oauth2.JwtGrantedAuthorityConverter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/auth/realms/**").permitAll()
        .and()
            .oauth2Login()
        .and()
