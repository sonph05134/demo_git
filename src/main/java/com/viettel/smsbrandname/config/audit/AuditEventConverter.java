package com.viettel.smsbrandname.config.audit;

import com.viettel.smsbrandname.domain.PersistentAuditEvent;
...
public class AuditEventConverter {
    ...
    /**
     * Internal conversion. This method will allow to saveOrEdit additional data.
     * By default, it will saveOrEdit the object as string.
     *
     * @param data the data to convert.
