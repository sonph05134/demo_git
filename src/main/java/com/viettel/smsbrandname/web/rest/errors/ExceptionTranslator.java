...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    protected ResponseEntity<Object> handleConflict(BusinessException ex) {
            return iResponseFactory.failBusiness(ex.getErrorCode(), ex.getMessage());
    }

    @ExceptionHandler(value = {Exception.class})
    protected ResponseEntity<Object> handleConflict(Exception ex) {
        return iResponseFactory.failBusiness(ErrorCodeResponse.UNKNOWN.getErrorCode(), ErrorCodeResponse.UNKNOWN.getMessageI18N());
    }
}
