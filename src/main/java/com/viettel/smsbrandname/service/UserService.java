...
import com.viettel.smsbrandname.domain.Authority;
import com.viettel.smsbrandname.domain.User;
import com.viettel.smsbrandname.repository.AuthorityRepository;
import com.viettel.smsbrandname.repository.UserRepository;
...
//                userSearchRepository.save(user);
    ...
    private User syncUserWithIdP(Map<String, Object> details, User user) {
        // saveOrEdit authorities in to sync user roles/groups between IdP and JHipster's local database
        ...
        // saveOrEdit account in to sync users between IdP and JHipster's local database
