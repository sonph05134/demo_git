...
To build the final jar and optimize the smsbrand_name application for production, run:
...
To package your application as a war in orders to deploy it to an application server, run:
